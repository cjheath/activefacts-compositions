...
module Warehousing
  ...
  class Product
    ...
    one_to_one      :product_id, mandatory: true        # Product has Product ID, see ProductID#product
  end
  ...
  class Warehouse
    ...
    one_to_one      :warehouse_id, mandatory: true      # Warehouse has Warehouse ID, see WarehouseID#warehouse
  end

  class PurchaseOrder
    identified_by   :purchase_order_id
    one_to_one      :purchase_order_id, mandatory: true  # Purchase Order has Purchase Order ID, see PurchaseOrderID#purchase_order
  ...
  class SalesOrder
    ...
    one_to_one      :sales_order_id, mandatory: true    # Sales Order has Sales Order ID, see SalesOrderID#sales_order
  ...
  class Bin
    ...
    one_to_one      :bin_id, mandatory: true            # Bin has Bin ID, see BinID#bin
  ...
  class Dispatch
    ...
    one_to_one      :dispatch_id, mandatory: true       # Dispatch has Dispatch ID, see DispatchID#dispatch
  end
  ...
  class TransferRequest
    ...
    one_to_one      :transfer_request_id, mandatory: true  # Transfer Request has Transfer Request ID, see TransferRequestID#transfer_request
  ...
  class DispatchItem
    ...
    one_to_one      :dispatch_item_id, mandatory: true  # Dispatch Item has Dispatch Item ID, see DispatchItemID#dispatch_item
  ...
  class Receipt
    ...
    one_to_one      :receipt_id, mandatory: true        # Receipt has Receipt ID, see ReceiptID#receipt
  end
  ...
  class ReceivedItem
    ...
    one_to_one      :received_item_id, mandatory: true  # Received Item has Received Item ID, see ReceivedItemID#received_item
