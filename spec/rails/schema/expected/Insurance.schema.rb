...
ActiveRecord::Schema.define(:version => 20160408160154) do
  ...
  create_table "claims", :id => false, :force => true do |t|
    ...
    t.column "p_sequence", :integer, limit: 32, null: false
    ...
    t.column "incident_police_report_nr", :integer, limit: 32, null: true
  ...
  create_table "lost_items", :id => false, :force => true do |t|
    ...
    t.column "lost_item_nr", :integer, limit: 32, null: false
    ...
    t.column "purchase_price", :decimal, limit: 18, limit: 2, null: true
  end
  ...
  create_table "parties", :id => false, :force => true do |t|
    ...
    t.column "person_year_nr", :integer, limit: 32, null: true
  ...
  create_table "policies", :id => false, :force => true do |t|
    ...
    t.column "p_year_nr", :integer, limit: 32, null: false
    t.column "p_product_id", :integer, null: false
    t.column "p_state_id", :integer, null: false
    t.column "p_serial", :integer, limit: 32, null: false
    t.column "application_nr", :integer, limit: 32, null: false
    t.column "insured_id", :integer, null: false
    t.column "authorised_rep_id", :integer, null: true
    t.column "itc_claimed", :decimal, limit: 18, limit: 2, null: true
  end
  ...
  create_table "products", :id => false, :force => true do |t|
    ...
    t.column "product_code", :integer, limit: 8, null: false
  ...
  create_table "states", :id => false, :force => true do |t|
    ...
    t.column "state_code", :integer, limit: 8, null: false
  ...
  create_table "third_parties", :id => false, :force => true do |t|
    ...
    t.column "model_year_nr", :integer, limit: 32, null: true
    t.column "vehicle_registration_nr", :string, limit: 8, null: true
    t.column "vehicle_type_make", :string, null: true
    t.column "vehicle_type_model", :string, null: true
    t.column "vehicle_type_badge", :string, null: true
  ...
  create_table "underwriting_demerits", :id => false, :force => true do |t|
    ...
    t.column "occurrence_count", :integer, limit: 32, null: true
  end
