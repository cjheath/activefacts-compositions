...
GO
CREATE UNIQUE NONCLUSTERED INDEX FilmByNameYearNr ON (Name, YearNr) WHERE YearNr IS NOT NULL
GO
...
GO
CREATE UNIQUE NONCLUSTERED INDEX PersonByLoginName ON (LoginName) WHERE LoginName IS NOT NULL
GO
